...
AND (T10.Resign = 'N' OR T10.[Resign Date] > '2023-06-06')
AND CONVERT(VARCHAR(10), T10.[Tgl. Kerja Lama], 120) <= '2023-06-06'




/** ÃÑ¿ø ±¸ÇÏ±â **/
SELECT * FROM tblAttendance AS T1 
INNER JOIN tblKaryawan AS T10 ON T1.NIK = T10.NIK
WHERE 1=1
AND T1.Tahun = '2023' AND T1.Bulan = '05'
AND (T10.Resign = 'N' OR T10.[Resign Date] > '2023-05-12')
AND CONVERT(VARCHAR(10), T10.[Tgl. Kerja Lama], 120) <= '2023-05-12'
