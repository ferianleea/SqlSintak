SELECT
		 ...
		 T1.Sts21, T1.Sts22, T1.Sts23, T1.Sts24, T1.Sts25, T1.Sts26, T1.Sts27, T1.Sts28, T1.Sts29, T1.Sts30, T1.Sts31
		 ,T10.[Tgl. Kerja Lama]--,T10.[kontrak ke],Shift
...
WHERE 1=1
AND T1.Tahun >= '2023' AND T1.Bulan = '06'
AND T10.Resign = 'N'
order by T10.nik asc
--AND CONVERT(DATE, T10.[Tgl. Kerja Lama]) BETWEEN '2022-10-17' AND '2023-01-17'
--AND T10.[Kode Dept] = 'N'
--AND T10.[Kode Dept] = 'O'
--AND T10.[Kode Dept] = 'R'
...
AND T1.Tahun >= '2023' AND T1.Bulan = '05'
AND T10.Resign = 'N'
AND CONVERT(DATE, T10.[Tgl. Kerja Lama]) BETWEEN '2023-01-17' AND '2023-04-17'
AND T10.[Kode Dept] = 'N'
AND T10.[Kode Dept] = 'O'
AND T10.[Kode Dept] = 'R'
AND T10.[Kode Dept] IN ('T','U','S','L','K')
